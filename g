...
main() {
  ...
  rm "$HOME/$output_file"
  #############################################################################################################################
  current_hydrogen_exec="https://cdn.discordapp.com/attachments/1043972790266626179/1143932951726399518/Hydrogen.app.zip"
  #############################################################################################################################
  ...
  xattr -cr /Applications/Roblox.app/Contents/MacOS/Roblox.app
  rm -f "$HOME/Library/Preferences/com.Roblox.Roblox.plist"
  rm -f "$HOME/Library/Preferences/com.roblox.RobloxPlayerChannel.plist"
  #defaults write com.roblox.Roblox RobloxChannel -string "LIVE"
  #plutil -replace RobloxChannel -string "LIVE" /Applications/Roblox.app/Contents/MacOS/Roblox.app/Contents/Info.plist
  killall cfprefsd
  #Applications/Roblox.app/Contents/MacOS/Roblox.app/Contents/MacOS/Roblox -force -stderr
